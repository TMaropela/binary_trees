 ...
 *
 * Return: If our node is a leaf, 1, otherwise, 0.
 */
unsigned char is_leaf(const binary_tree_t *node)
{
 ...
 * @leaf_depth: The depth of one leeaf in the binary tree.
...
/**
 * binary_tree_is_perfect - Checkng if a binary tree is perfect.
 * @tree: A pointer to the root node of the tree to check.
 *
