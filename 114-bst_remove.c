...
/**
 * inorder_successor - Returning the minimum value of a binary search tree.
...
/**
 * bst_delete - Deleting a node from a binary search tree.
...
/**
 * bst_remove_recursive - Removing a node from a binary search tree recursively.
